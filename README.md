...
**Votre réponse :** npm --save vue-router car elle installe sur le porjet les dépandances, au changement de machine, on pourra juste faire un npm install pour avoir les routes qui fonctionne
